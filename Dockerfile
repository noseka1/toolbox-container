...
FROM docker.io/fedora:42 as golang-builder
...
FROM docker.io/fedora:42 as basic
...
COPY toolbox_webterm_start.sh toolbox_webterm_upgrade.sh devworkspace.yaml /usr/local/bin
